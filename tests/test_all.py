...
print("\nTest avec n = 8")
res_graphe_8 = np_hard.tsp_force_brute(graphe_8, depart=0)
print("Coût optimal :", res_graphe_8["cout"])
print("Chemin optimal :", res_graphe_8["chemin"])
...
# print("Coût optimal :", res_graphe_12["cout"])
# print("Chemin optimal :", res_graphe_12["chemin"])
...
print("\nTest avec n = 20")
print("Prend beaucoup de temps, vous pouvez décommenter le test si nécessaire")
# res_graphe_20 = np_hard.tsp_force_brute(graphe_20, depart=0)
# print("Coût optimal :", res_graphe_20["cout"])
# print("Chemin optimal :", res_graphe_20["chemin"])
...
print("\nTest avec n = 8")
res_graphe_8 = np_hard.tsp_nearest_neighbor(graphe_8, depart=0)
print("Coût du chemin trouvé :", res_graphe_8["cout"])
...
print("Coût du chemin trouvé :", res_graphe_20["cout"])
print("Chemin trouvé :", res_graphe_20["chemin"])
print("Temps :", res_graphe_20["temps"], "secondes")

print("\n--- TSP par programmation dynamique ---")
print("\nTest avec n = 8")
res_graphe_8 = np_hard.tsp_programmation_dynamique_mesure(graphe_8, depart=0)
print("Coût :", res_graphe_8["cout"])
print("Chemin :", res_graphe_8["chemin"])
print("Qualité :", res_graphe_8["qualite"])
print("Temps :", res_graphe_8["temps"], "secondes")
print("Ratio :", res_graphe_8["ratio"])
...
print("Chemin :", res_graphe_12["chemin"])
print("Qualité :", res_graphe_12["qualite"])
print("Temps :", res_graphe_12["temps"], "secondes")
print("Ratio :", res_graphe_12["ratio"])
...
print("\nTest avec n = 20")
print("Prend beaucoup de temps, vous pouvez décommenter le test si nécessaire")
# res_graphe_20 = np_hard.tsp_programmation_dynamique_mesure(graphe_20, depart=0)
# print("Coût :", res_graphe_20["cout"])
# print("Chemin :", res_graphe_20["chemin"])
# print("Qualité :", res_graphe_20["qualite"])
# print("Temps :", res_graphe_20["temps"], "secondes")
# print("Ratio :", res_graphe_20["ratio"])
